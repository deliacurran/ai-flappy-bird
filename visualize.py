...
def draw_net(config, genome, view=False, filename="nn.svg", node_names=None, show_disabled=True, prune_unused=False,
    ...
    if prune_unused:
        ...
        while pending:
            ...
            for input_node, output_node in connections:
                if output_node in pending and input_node not in used_nodes:
                    new_pending.add(input_node)
