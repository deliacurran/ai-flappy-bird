...
END_FONT = pygame.font.SysFont("verdana", 70)
DRAW_LINES = False
...
def eval_genomes(genomes, config):
    ...
    # Three lists, one for the genome, one for the nn holding the genome, and the bird object
    nets = []
    birds = []
    ge = []
...
def run(config_file):
    ...
    # Visualize the stats and species over generations
